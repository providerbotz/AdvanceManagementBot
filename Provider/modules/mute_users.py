...
from Provider.functions.handlers import Mute

@AdvanceManagementBot.on_message(Mute.a)
...
@AdvanceManagementBot.on_message(Mute.b)
...
@AdvanceManagementBot.on_message(Mute.c)
