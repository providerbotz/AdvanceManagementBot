...
from Provider.functions.media_details import humanbytes, get_size
from Provider.functions.commands import button, markup, message               
from Provider.functions.settings import get_settings 
from Provider.functions.loadings import loading
from Provider.database import db, Media
from Provider import Configs, Index, Bots
from Provider.provider import AutoFilterBot
from Provider.scripts import Txt
...
class vars(object):
    def start_buttons(Bot_Username):
        keyword = [[
            ...
            button()("Support", url="https://t.me/"),
            button()("Updates",url="https://t.me/")
            ],[
    ...
    about_buttons = [[
        button()("Support", url="https://t.me/"),
        button()("Source", url="https://t.me/")
        ],[
        button()("Tutorial", url="https://youtu.be/"),
        button()("Insta", url="https://www.instagram.com/")
        ],[
